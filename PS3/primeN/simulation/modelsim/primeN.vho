...
SIGNAL \dut_instance|OR3|Y~0_combout\ : std_logic;
...
\dut_instance|OR3|Y~0\ : maxv_lcell
-- Equation(s):
-- \dut_instance|OR3|Y~0_combout\ = (\input_vector~combout\(2) & (\input_vector~combout\(0) & ((!\input_vector~combout\(1)) # (!\input_vector~combout\(3))))) # (!\input_vector~combout\(2) & (\input_vector~combout\(1) & ((\input_vector~combout\(0)) # 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|OR3|Y~0_combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|OR3|Y~0_combout\,
	oe => VCC,
