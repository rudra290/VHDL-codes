...
SIGNAL \dut_instance|NAND_05|Y~0_combout\ : std_logic;
...
\dut_instance|NAND_05|Y~0\ : maxv_lcell
-- Equation(s):
-- \dut_instance|NAND_05|Y~0_combout\ = ((\input_vector~combout\(0) $ (\input_vector~combout\(1))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|NAND_05|Y~0_combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|NAND_05|Y~0_combout\,
	oe => VCC,
